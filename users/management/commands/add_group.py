...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        perm = Permission.objects.get(content_type__app_label='client', content_type__model='client',
                                      codename='add_client')
        ...
        perm = Permission.objects.get(content_type__app_label='mailing', content_type__model='mailing',
